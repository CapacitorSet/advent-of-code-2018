...
object Application {
	...
	@tailrec
	def iterate(circle: Vector[Int], marble: Int, scores: Map[Int, Int]): (Vector[Int], Int, Map[Int, Int]) =
	...
	def main(args: Array[String]): Unit = {
		...
		highestMarble = highestMarbleStr.toInt
		val initScores = (0 to numPlayers).map((_, 0)).toMap
